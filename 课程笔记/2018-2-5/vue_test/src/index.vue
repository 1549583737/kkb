...
export default {
  components: {
    ...
    cmpRightadDiv: import('@/components/cmp-rightad-div'),
    cmpGuessdetailDiv: import('@/components/cmp-guessdetail-div'),
    cmpInfoitemDiv: import('@/components/cmp-infoitem-div')
  },
  data () {
    let dataBus = {
      houseData: []
